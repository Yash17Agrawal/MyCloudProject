<%-- 
    ...
    Created on : May 9, 2017, 1:25:21 AM
    Author     : code_eagle
--%>
...
<div class="container-fluid bg-1 text-center">
  ...
  <button ><a href="http://localhost:24807/MyCloudProject-war/Logout">Logout</a></button>
  <h3>ADMIN</h3>
...
<div class="container-fluid bg-4 text-center">
	...
	<div class="row">
		...
		<div class="col-md-3" > TRANS. ID</div>
		<div class="col-md-3" > ACCOUNT</div>
		<div class="col-md-3" > RATE</div>
                <div class="col-md-3" > PRINCIPAL</div>
...
<div class="container-fluid bg-3 text-center">
	...
	<div class="row">
		...
		<div class="col-md-3" ><%=temp.get(2)%> </div>
                ...
                <div class="col-md-3" ><%=temp.get(4)%> </div>
                <div class="col-md-3" ><%=temp.get(5)%> </div>
